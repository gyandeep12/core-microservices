...
These are the 3 basic services used in the most distributed Micro-Service Architecture Systems. We are using Go for creating a reverse proxy and Java for service discovery and registering profiles.
